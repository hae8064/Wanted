...
const GridCard = ({
  ...
  return (
    <div className="GridCard">
      <a href="/" class="gridContainerFirst">
        <header>
          <svg
        ...
        <footer>
          ...
          <span class="gridTitle2">{companyName}</span>
          ...
          {respone ? (
            ...
            <button class="gridButton" style={{ display: "none" }}>
              <span>{respone}</span>
            </button>
          )}
          <span class="gridTitle3">
            {city} <span class="addressDot">.</span> <span>{country}</span>
          </span>
          <span class="gridTitle4">채용보상금 {price}원</span>
        </footer>
      </a>
    </div>
  );
