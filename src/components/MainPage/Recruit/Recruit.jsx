...
function Recruit() {
  return (
    <div class="recruitInformContainer">
      <div class="recruitInformTop">
        <h2 class="recruitInformText">채용 정보를 찾고 계셨나요?</h2>
      </div>

      <div class="recruitInformBottom">
        <div class="recruitInformfirst">
          <a class="InformBottomSeconda" href="/">
            <Recruit1 />
          </a>
          <a class="InformBottomFirsta" href="/">
        ...
        <div class="recruitInformSecond">
          <a class="InformBottomSeconda" href="/">
            <svg class="SvgIcon_SvgIcon__root__svg__DKYBi" viewBox="0 0 32 32">
